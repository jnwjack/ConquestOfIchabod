...
// Spritemap positions
#define BATTLE_SPRITEMAP_A_BOX 2
#define BATTLE_SPRITEMAP_E_BOX 1
#define BATTLE_SPRITEMAP_DESC_BOX 9
#define BATTLE_SPRITEMAP_SPLASH_BOX 10
#define BATTLE_SPRITEMAP_POINTER 6
#define BATTLE_SPRITEMAP_MENU_FRAME 4
#define BATTLE_SPRITEMAP_MENU_POINTER 5
#define BATTLE_SPRITEMAP_SUBMENU_FRAME 7
#define BATTLE_SPRITEMAP_SUBMENU_POINTER 8
#define BATTLE_SPRITEMAP_NAME_BOX 3
